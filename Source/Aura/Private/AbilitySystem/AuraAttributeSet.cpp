...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagToAttributes.Add(GameplayTags.Attributes_Secondary_CriticalHitResistence, GetCriticalHitResistenceAttribute);
...
void UAuraAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	if(Data.EvaluatedData.Attribute == GetHealthAttribute())
	{
		...
		UE_LOG(LogTemp, Warning, TEXT("Health Changed on %s, Health: %f"), *Props.TargetActor->GetName(), GetHealth());
	}
...
void UAuraAttributeSet::Debuff(const FEffectProperties& Props)
{
	...
	EffectContext.AddSourceObject(Props.SourceActor);
...
{
	if(Props.SourceActor != Props.TargetCharacter)
	{
...
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UAuraAttributeSet, MaxMana, OldCriticalHitResistence);
}
