...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Attributes_Secondary_CriticalHitResistence = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Secondary.CriticalHitResistence"), FString("Reduces Critical Hit Chance of attacking enemies"));
	...
	GameplayTags.InputPassive_1 = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("InputPassive.1"), FString("Input Tag Passive 1"));
	
	GameplayTags.InputPassive_2 = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("InputPassive.2"), FString("Input Tag Passive 2"));
	...
	GameplayTags.HitReact = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("HitReact"), FString("Tag Granted when Hit Reacting"));

	// Abilities

	GameplayTags.Abilities_None = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Abilities.None"), FString("No Abilities"));
	...
	GameplayTags.Abilities_Lightning_Eletrocute = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Abilities.Lightning.Eletrocute"), FString("Eletrocute Ability Tag"));
